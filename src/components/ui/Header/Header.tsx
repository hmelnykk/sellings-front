...
const Header = () => {
    ...
    return (
        <>
            <ModalBase isOpen={isMobileMenuOpen} onClose={() => {
                setIsMobileMenuOpen(false);
                document.body.classList.remove('overflow-y-hidden');
            }}>
                <div className="bg-white rounded-default p-4 w-[75%] h-[75%]">
            ...
            <div className="bg-primary relative">
                <header className="container mx-auto flex p-4 items-center justify-between ">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 max-sm:hidden">
                ...
                <div className="max-lg:hidden container relative mx-auto flex gap-4 p-4">
                    <Button
                        name="Catalog"
                        icon={
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        className="flex-grow hover:border-sky-600 flex items-center justify-center gap-2"
                    />
